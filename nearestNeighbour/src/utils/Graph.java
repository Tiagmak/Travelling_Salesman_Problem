...
public class Graph {
    ...
    public Graph(int n) {                              //construtor do grafo
        this.n = n;
    ...
    public void bfs(int v) {
        ...
        for (int i = 1; i <= n; i++)
            nodes[i].visited = false;                     //ao meter aqui tudo a falso, permite correr o BFS varias vezes no mesmo grafo, ao fazer isso conseguimos começar uma vez em cada no e guardar as distancias de uns para os outros
